<?php
/**
 * The template for displaying comment list page
 *
 * @package WordPress
                ...
                <div class="entry-content">
                    ...
                    <p class=''><span class='title'></span><span class=''>
                        <label>Order by <select name="orderby">
                            <option value="comment_date" selected>date</option>
                            <option value="comment_author">author</option>
                            <option value="comment_post_ID">post</option>
                        </select></label></span></p>
